...
import contractABI from "./config.json";
import SepoliaNft from "./contract-config.json";
import uris from "./ipfs_addresses.json";
import "./App.css";
...
function App() {
  ...
  const contract = SepoliaNft.contractAddress;
